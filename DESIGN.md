...
- **Don't** colocar eyebrows em uppercase com tracking largo acima de cada seção ("SOBRE NÓS", "COMO FUNCIONA", "PREÇOS"). Isso é o padrão de IA de 2023 — uma ocorrência deliberada como sistema é voz; uma em cada seção é gramática de IA.
