...
/**
 * Monta os params da busca sobrescrevendo só o ESCOPO (dest/from/to/vehicle) e mantendo os demais
 * filtros vindos de `base` (quando informado). Sempre zera a paginação (`offset`) — é uma busca nova.
 */
export function buildSearchParams({ base, dest, from, to, vehicle }: BuildArgs): URLSearchParams {
