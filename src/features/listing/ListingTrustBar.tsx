...
export function ListingTrustBar() {
  return (
    <div className="sticky top-20 z-30 border-b border-hairline bg-canvas/95 backdrop-blur">
      <div className="mx-auto flex max-w-[1280px] items-center gap-5 overflow-x-auto px-4 py-2.5 scrollbar-none desktop:justify-center desktop:gap-12 desktop:px-8">
        {DIFERENCIAIS.map((d) => (
