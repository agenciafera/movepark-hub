...
/**
 * A área do grupo: quais produtos existem sob a marca Movepark e em que estágio.
 *
 * O leitor é metade do alvo. A outra metade é a entidade: até esta página existir,
 * a Go2Park só aparecia no site como selo de três unidades, e nenhuma superfície de
 * máquina dizia o nome dela, então LLM perguntado sobre a Go2Park não tinha de onde
 * tirar o vínculo com a casa.
 *
 * A regra de escrita, que vale para toda edição futura (ver docs/specs/grupo-movepark.md):
 * o texto fala em produtos da mesma casa, e o dado estruturado afirma só `brand`
 * enquanto a Go2Park faturar pelo CNPJ da Agência Fera. Nada aqui pode dizer
 * "subsidiária", "controlada" ou "empresa do grupo Movepark" antes de a titularidade
 * mudar, porque isso é afirmação societária e o contrato social ainda não a sustenta.
 */
export const GRUPO: ContentPage = {
  slug: "grupo",
  label: "O grupo",
  title: "O grupo Movepark",
  intro:
    "São quatro produtos em torno da mesma ideia: vaga e van com hora marcada, preço combinado antes e acompanhamento até o fim. Esta página diz o que é cada um, em que estágio está e quem responde por ele.",
  updated: "2026-09-18",
  sections: [
    {
      id: "a-ideia",
      title: "A ideia por trás dos quatro",
      blocks: [
        {
          type: "p",
          text: "Estacionar perto do aeroporto e pegar a van do traslado são as duas partes da viagem que ninguém consegue prever. Você sai de casa sem saber se vai ter vaga, quanto vai pagar na saída e quanto tempo vai esperar pela van.",
        },
        {
          type: "p",
          text: "Cada produto da casa pega um pedaço disso e aplica a mesma receita: o combinado fica escrito antes de você sair, o pagamento acontece uma vez só, e quem está esperando consegue ver o que está acontecendo.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: "p",
          text: "É a plataforma de reserva onde você está agora. Busca pelo destino, compara os estacionamentos parceiros, escolhe o tipo de vaga e paga online. O valor da tela é o valor da reserva, sem taxa na chegada.",
        },
        {
          type: "p",
          text: "O pagamento é dividido na hora da compra entre a Movepark e o estacionamento. O parceiro recebe a parte dele direto do meio de pagamento, sem abrir conta em lugar nenhum e sem depender de repasse manual no fim do mês.",
        },
        {
          type: "p",
          text: "Quem prefere resolver pelo WhatsApp fala com um assistente que entende o pedido, consulta o preço daquela unidade e devolve o link de pagamento na própria conversa.",
        },
        {
          type: "note",
          label: "Estágio",
          text: "No ar, com reserva e pagamento funcionando em todas as unidades parceiras.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: "p",
          text: "A Go2Park mostra no mapa, em tempo real, a van que está indo buscar você. Não precisa instalar aplicativo nem criar conta: o link abre no navegador do celular e avisa quando a van se aproxima.",
        },
        {
          type: "p",
          text: "Três estacionamentos parceiros já operam com ela: um no Aeroporto Afonso Pena, em Curitiba, e dois no Aeroporto de Viracopos, em Campinas. Nas páginas dessas unidades o rastreio aparece em destaque, porque nenhum vizinho de aeroporto oferece o mesmo.",
        },
        {
          type: "link",
          text: "O produto tem site próprio:",
          href: "https://go2park.com.br",
          label: "go2park.com.br",
        },
        {
          type: "note",
          label: "Estágio",
          text: "No ar, em três unidades com contrato.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: "p",
          text: "A Go2Med leva o mesmo rastreio para o transporte de hospital. Paciente e família passam a ver onde está a van que vai buscá-lo, e a equipe acompanha a frota sem precisar ligar para o motorista a cada viagem.",
        },
        {
          type: "note",
          label: "Estágio",
          text: "Em desenvolvimento. Ainda não está disponível para contratação.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: "p",
          text: "O Coopark é para quem estaciona todo dia no mesmo lugar. Ele junta quem procura vaga mensal na mesma região e leva essa demanda somada até os estacionamentos com vaga parada, o que abre espaço para um preço melhor do que o de quem negocia sozinho no balcão.",
        },
        {
          type: "note",
          label: "Estágio",
    ...
    {
      id: "quem-responde",
      title: "Quem responde por cada produto",
      blocks: [
        {
          type: "p",
          text: "A Movepark Tecnologia Ltda, CNPJ 68.183.164/0001-35, responde pelo Movepark Hub. É o nome que aparece na sua cobrança e no seu comprovante.",
        },
        {
          type: "p",
          text: "A Go2Park opera hoje pelo CNPJ da Agência Fera, a casa de desenvolvimento e marketing que atende a operação. O time é o mesmo, e a titularidade passa para a Movepark conforme cada produto amadurece.",
        },
        {
          type: "note",
          label: "Por que isso está escrito aqui",
          text: "Porque muda o nome que você vê na cobrança. Preferimos dizer antes a deixar você descobrir na fatura.",
        },
      ],
    },
    {
      id: "pra-nao-confundir",
      title: "Para não confundir",
      blocks: [
        {
          type: "p",
          text: "A Movepark não opera pátio próprio. Quem guarda o carro é o estacionamento parceiro, com nome, endereço e avaliação na página de cada unidade.",
        },
        {
          type: "p",
          text: "Existem empresas e estacionamentos com nome parecido, sem nenhuma relação com esta casa. O CNPJ acima é o que identifica a Movepark, e o site oficial é movepark.co.",
        },
      ],
    },
  ],
  related: ["sobre", "como-funciona", "metodologia"],
};
...
export const RELACIONADOS: Record<string, { to: string; title: string; description: string }> = {
  ...
  grupo: {
    to: "/grupo",
    title: "O grupo Movepark",
    description: "Os quatro produtos da casa e o estágio de cada um",
  },
};
