...
const COBERTAS_POR_PLAYWRIGHT: Record<string, string> = {
  ...
  "/operator/bookings": "lista de operação com reserva real",
  "/operator/bookings/:code": "tela da reserva com as ações de operação (O02 abre pela linha e marca no-show)",
