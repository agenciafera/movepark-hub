  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        description="Preço e disponibilidade dos planos Flex e Superflex por tipo de vaga. A Básica é sempre grátis. Só a equipe Movepark edita. O preço da diária fica em Preços."
      />
