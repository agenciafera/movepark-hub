...
export default function OperatorLocationEdit() {
  ...
  return (
    <form className="flex flex-col gap-6" onSubmit={form.submit}>
      ...
      {/* Barra fixa: o formulário tem seis blocos e passa da dobra em qualquer
          tela. Sem isto, salvar exige rolar até o fim toda vez. */}
      <div className="sticky bottom-0 -mx-4 flex items-center justify-end gap-2 border-t border-hairline bg-canvas px-4 py-3 desktop:-mx-8 desktop:px-8">
