-- Estorno pago pelo master libera na hora (17/09/2026). Spec: docs/specs/conta-do-parceiro.md.
--
-- Uma venda estornada pela Movepark (recebedor sem saldo) aparecia em "Retido pelo prazo": o
-- líquido dela ficou com o parceiro e virou dívida, mas o prazo de 30 dias ainda a segurava. O
-- prazo existe para cobrir estorno futuro; estornada, não há o que cobrir. A fração estornada pelo
-- master passa a contar como liberada na hora, e a dívida abate em seguida. O disponível não muda
-- (liberado − dívida dá o mesmo); o que muda é o retido, que deixa de mostrar dinheiro que não vem.
