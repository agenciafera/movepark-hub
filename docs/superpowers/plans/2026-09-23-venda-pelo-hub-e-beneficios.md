...
Graph API (UTILITY, pt_BR, nomes em tarifas-operacao.md §3a), aprovados no mesmo dia, com os
segredos apontando para eles e envio de teste feito. Se um template cair, o aviso vai por e-mail.
