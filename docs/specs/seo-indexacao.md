...
- [ ] **`www.movepark.co` responde 522.** Medido em 18/08/2026. Não é duplicata (não serve conteúdo), mas 522 é erro de origem, não uma resposta deliberada. O certo é 301 para o apex, ou tirar o registro.
