...
**Rota:** `/operator/coupons`

**Objetivo:** o operador cria e gerencia os cupons de desconto da própria empresa. Ver o motor completo em [coupon-rules.md](./coupon-rules.md).
