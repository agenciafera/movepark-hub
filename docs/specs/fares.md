...
| **Superflex** | **R$ 24,90** | até **1 min** antes (estorno total) | + proteção de voo, atraso ou cancelamento (24h por conta da Movepark, uma vez; o que passar é cobrado no balcão pelo parceiro, ver tarifas-operacao.md §2.7). Suporte prioritário saiu do catálogo em 25/09/2026 (ver chamado-de-atendimento.md) |
